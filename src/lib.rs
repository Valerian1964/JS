// src/lib.rs
/*
 * Core library for JSONValidator
 */
...
#[derive(Debug)]
pub struct JSONValidatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JSONValidatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JSONValidator processing");
    
    let mut processor = JSONValidatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JSONValidatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JSONValidatorProcessor::new(false);
